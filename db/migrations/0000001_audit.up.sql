...
-- https://github.com/supabase/supa_audit/blob/main/supa_audit--0.3.0.sql
...
begin
  ...
  if (
    ...
    where (nsp.nspname , f.proname , pt.typname) in (('auth' , 'uid' , 'uuid') , ('auth' ,
      'role' , 'text')) and f.pronargs = 0) then
