...
begin
  ...
  insert into users (user_id , username , email , first_name , last_name , role)
    values (admin_id , 'admin' , 'admin@email.com' , 'Admin' ,
      'Doe' , 'superadmin'::user_role);
  insert into users (user_id , username , email , first_name , last_name , role)
    values (manager_1_id , 'manager 1' , 'manager1@email.com' , 'Mr.Manager' ,
      'Smith' , 'superadmin'::user_role);
  insert into users (user_id , username , email , first_name , last_name , role)
