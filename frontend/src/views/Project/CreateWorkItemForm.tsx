...
import type { CreateDemoWorkItemRequest, WorkItemRole } from 'src/gen/model'
...
export default function CreateWorkItemForm() {
  ...
  const createDemoWorkItemRequestSchema = JSON_SCHEMA.definitions.CreateDemoWorkItemRequest
  ...
  const createDemoWorkItemForm = useForm<CreateDemoWorkItemRequest>({
    resolver: ajvResolver(createDemoWorkItemRequestSchema as any, {
      strict: false,
      formats: fullFormats,
    }),
    mode: 'all',
    ...
    defaultValues: {
      projectName: 'demo', // discriminator
    },
  })
  ...
  return (
    <>
      ...
      <FormProvider {...createDemoWorkItemForm}>
        <DynamicForm<CreateDemoWorkItemRequest, 'base.metadata' | 'projectName'>
          onSubmit={(e) => {
            e.preventDefault()
          ...
          formName={formName}
          schemaFields={parseSchemaFields(createDemoWorkItemRequestSchema)}
          options={{
            labels: {
              base: '',
              tagIDs: 'Tags',
