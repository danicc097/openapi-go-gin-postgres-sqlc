...
export default function DemoMantineReactTable() {
  const _columns = useMemo<MRT_ColumnDef<User>[]>(
    () => [
      // TODO: actual need a appendColumns helper that overrides objects by accessorKey, mrt just keeps the first...
  ...
  const columns = useMemo<MRT_ColumnDef<User>[]>(() => {
    const uniqueColumns = new Map<string, MRT_ColumnDef<User>>()
