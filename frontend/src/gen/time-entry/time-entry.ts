...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetTimeEntryQueryKey(timeEntryID);
   ...
   return  { queryKey, queryFn, enabled: !!(timeEntryID),  cacheTime: 2000, refetchOnWindowFocus: false, refetchOnMount: false, retryOnMount: false, staleTime: Infinity, keepPreviousData: true,  ...queryOptions} as UseInfiniteQueryOptions<Awaited<ReturnType<typeof getTimeEntry>>, TError, TData> & { queryKey: QueryKey }
}
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetTimeEntryQueryKey(timeEntryID);
   ...
   return  { queryKey, queryFn, enabled: !!(timeEntryID),  cacheTime: 2000, refetchOnWindowFocus: false, refetchOnMount: false, retryOnMount: false, staleTime: Infinity, keepPreviousData: true,  ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getTimeEntry>>, TError, TData> & { queryKey: QueryKey }
}
...
export const useUpdateTimeEntry = <TError = ErrorType<void | HTTPError>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateTimeEntry>>, TError,{timeEntryID: EntityIDs.TimeEntryID;data: UpdateTimeEntryRequest}, TContext>, request?: SecondParameter<typeof customInstance>}
        ...
        TError,
        {timeEntryID: EntityIDs.TimeEntryID;data: UpdateTimeEntryRequest},
        TContext
      > => {
...
export const getDeleteTimeEntryMutationOptions = <TError = ErrorType<void | HTTPError>,
...
const {mutation: mutationOptions, request: requestOptions} = options ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type DeleteTimeEntryMutationError = ErrorType<void | HTTPError>

    /**
 * @summary delete time-entry.
 */
export const useDeleteTimeEntry = <TError = ErrorType<void | HTTPError>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof deleteTimeEntry>>, TError,{timeEntryID: EntityIDs.TimeEntryID}, TContext>, request?: SecondParameter<typeof customInstance>}
): UseMutationResult<
