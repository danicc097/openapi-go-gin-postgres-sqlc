...
export const getGetProjectInfiniteQueryOptions = <TData = Awaited<ReturnType<typeof getProject>>, TError = unknown>(
  ...
  return { queryKey, queryFn, enabled: !!projectName, staleTime: 3600000, ...queryOptions } as UseInfiniteQueryOptions<
...
export const getGetProjectQueryOptions = <TData = Awaited<ReturnType<typeof getProject>>, TError = unknown>(
  ...
  return { queryKey, queryFn, enabled: !!projectName, staleTime: 3600000, ...queryOptions } as UseQueryOptions<
    Awaited<ReturnType<typeof getProject>>,
    TError,
    TData
  > & { queryKey: QueryKey }
...
>(
  ...
  return { queryKey, queryFn, enabled: !!projectName, staleTime: 3600000, ...queryOptions } as UseInfiniteQueryOptions<
    Awaited<ReturnType<typeof getProjectBoard>>,
    TError,
    TData
  > & { queryKey: QueryKey }
}
...
>(
  ...
  return { queryKey, queryFn, enabled: !!projectName, staleTime: 3600000, ...queryOptions } as UseInfiniteQueryOptions<
    Awaited<ReturnType<typeof getProjectWorkitems>>,
    TError,
    TData
  > & { queryKey: QueryKey }
}
