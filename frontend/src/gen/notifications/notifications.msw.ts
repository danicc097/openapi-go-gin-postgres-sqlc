...
export const getGetPaginatedNotificationsMock = () => ({
  items: Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, (_, i) => i + 1).map(() => ({
    notification: {
      ...
      notificationID: faker.number.int({ min: undefined, max: undefined }) as EntityIDs.NotificationID,
    ...
    userNotificationID: faker.number.int({ min: undefined, max: undefined }) as EntityIDs.UserNotificationID,
  })),
