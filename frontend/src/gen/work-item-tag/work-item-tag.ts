...
export const getWorkItemTag = (
  workItemTagID: Branded<number, 'workItemTagID'>,
  options?: SecondParameter<typeof customInstance>,
  signal?: AbortSignal,
) => {
...
export const getGetWorkItemTagQueryKey = (workItemTagID: Branded<number, 'workItemTagID'>) => {
...
export const getUpdateWorkItemTagMutationOptions = <TError = void | HTTPError, TContext = unknown>(options?: {
  mutation?: UseMutationOptions<
    ...
    TError,
    { workItemTagID: Branded<number, 'workItemTagID'>; data: UpdateWorkItemTagRequest },
    TContext
  >
  request?: SecondParameter<typeof customInstance>
}): UseMutationOptions<
