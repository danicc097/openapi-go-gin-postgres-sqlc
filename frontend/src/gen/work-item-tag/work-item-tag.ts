...
export const getCreateWorkItemTagMutationOptions = <TError = void | HTTPError, TContext = unknown>(options?: {
  mutation?: UseMutationOptions<
    ...
    TError,
    { projectName: 'demo' | 'demo_two'; data: RestCreateWorkItemTagRequest },
    TContext
  >
...
export const getWorkItemTag = (
  ...
  return customInstance<RestWorkItemTag>({ url: `/work-item-tag/${workItemTagID}`, method: 'GET', signal }, options)
}
...
export const getUpdateWorkItemTagMutationOptions = <TError = void | HTTPError, TContext = unknown>(options?: {
  mutation?: UseMutationOptions<
    ...
    TError,
    { workItemTagID: EntityIDs.WorkItemTagID; data: RestUpdateWorkItemTagRequest },
    TContext
  >
  request?: SecondParameter<typeof customInstance>
}): UseMutationOptions<
