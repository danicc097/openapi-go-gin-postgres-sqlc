...
export const getWorkItemTypeMock = () => [
  ...
  http.get('*/project/:projectName/workItemType/:id/', async () => {
    await delay(1000)
  ...
  http.patch('*/project/:projectName/workItemType/:id/', async () => {
    await delay(1000)
  ...
  http.delete('*/project/:projectName/workItemType/:id/', async () => {
    await delay(1000)
