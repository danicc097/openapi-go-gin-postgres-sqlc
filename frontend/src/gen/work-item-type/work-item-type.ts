...
} from '../model/createWorkItemTypeRequest'
import type {
  HTTPError
} from '../model/hTTPError'
import type {
  UpdateWorkItemTypeRequest
} from '../model/updateWorkItemTypeRequest'
import type {
  WorkItemType
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetWorkItemTypeQueryKey(workItemTypeID);
   ...
   return  { queryKey, queryFn, enabled: !!(workItemTypeID),  cacheTime: 300000, refetchOnWindowFocus: false, refetchOnMount: false, retryOnMount: false, staleTime: Infinity, keepPreviousData: true,  ...queryOptions} as UseInfiniteQueryOptions<Awaited<ReturnType<typeof getWorkItemType>>, TError, TData> & { queryKey: QueryKey }
}
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetWorkItemTypeQueryKey(workItemTypeID);
   ...
   return  { queryKey, queryFn, enabled: !!(workItemTypeID),  cacheTime: 300000, refetchOnWindowFocus: false, refetchOnMount: false, retryOnMount: false, staleTime: Infinity, keepPreviousData: true,  ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getWorkItemType>>, TError, TData> & { queryKey: QueryKey }
}
