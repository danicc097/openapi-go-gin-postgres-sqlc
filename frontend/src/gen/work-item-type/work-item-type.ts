...
export const getGetWorkItemTypeQueryKey = (workItemTypeID: Branded<number, 'workItemTypeID'>) => {
...
export const getUpdateWorkItemTypeMutationOptions = <TError = void | HTTPError, TContext = unknown>(options?: {
  mutation?: UseMutationOptions<
    ...
    TError,
    { workItemTypeID: Branded<number, 'workItemTypeID'>; data: UpdateWorkItemTypeRequest },
    TContext
  >
  request?: SecondParameter<typeof customInstance>
}): UseMutationOptions<
