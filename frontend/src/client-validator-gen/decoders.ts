...
export const HTTPValidationErrorDecoder: Decoder<HTTPValidationError> = {
  ...
  decode(json: unknown): HTTPValidationError {
    ...
    if (!schema) {
      throw new Error(
        `Schema ${HTTPValidationErrorDecoder.definitionName} not found`
      );
    }
    return validateJson(
      json,
      schema,
      HTTPValidationErrorDecoder.definitionName
    );
  },
};
...
export const UpdateUserRequestDecoder: Decoder<UpdateUserRequest> = {
  ...
  decode(json: unknown): UpdateUserRequest {
    ...
    if (!schema) {
      throw new Error(
        `Schema ${UpdateUserRequestDecoder.definitionName} not found`
      );
    }
...
export const CreateUserRequestDecoder: Decoder<CreateUserRequest> = {
  ...
  decode(json: unknown): CreateUserRequest {
    ...
    if (!schema) {
      throw new Error(
        `Schema ${CreateUserRequestDecoder.definitionName} not found`
      );
    }
...
export const CreateUserResponseDecoder: Decoder<CreateUserResponse> = {
  ...
  decode(json: unknown): CreateUserResponse {
    ...
    if (!schema) {
      throw new Error(
        `Schema ${CreateUserResponseDecoder.definitionName} not found`
      );
    }
...
export const allof_tag_api_responseDecoder: Decoder<allof_tag_api_response> = {
  ...
  decode(json: unknown): allof_tag_api_response {
    ...
    if (!schema) {
      throw new Error(
        `Schema ${allof_tag_api_responseDecoder.definitionName} not found`
      );
    }
    return validateJson(
      json,
      schema,
      allof_tag_api_responseDecoder.definitionName
    );
  },
};
...
export const updatePet_requestDecoder: Decoder<updatePet_request> = {
  ...
  decode(json: unknown): updatePet_request {
    ...
    if (!schema) {
      throw new Error(
        `Schema ${updatePet_requestDecoder.definitionName} not found`
      );
    }
...
export const updatePetWithForm_requestDecoder: Decoder<updatePetWithForm_request> =
  {
    ...
    decode(json: unknown): updatePetWithForm_request {
      ...
      if (!schema) {
        throw new Error(
          `Schema ${updatePetWithForm_requestDecoder.definitionName} not found`
        );
      }
      return validateJson(
        json,
        schema,
        updatePetWithForm_requestDecoder.definitionName
      );
    },
  };
export const uploadFile_requestDecoder: Decoder<uploadFile_request> = {
  ...
  decode(json: unknown): uploadFile_request {
    ...
    if (!schema) {
      throw new Error(
        `Schema ${uploadFile_requestDecoder.definitionName} not found`
      );
    }
...
export const ValidationErrorDecoder: Decoder<ValidationError> = {
  ...
  decode(json: unknown): ValidationError {
    ...
    if (!schema) {
      throw new Error(
        `Schema ${ValidationErrorDecoder.definitionName} not found`
      );
    }
