...
export const schemaDefinitions = {
  HTTPValidationError: info<HTTPValidationError>(
    "HTTPValidationError",
  ...
  UpdateUserRequest: info<UpdateUserRequest>(
    "UpdateUserRequest",
    "#/definitions/UpdateUserRequest"
  ),
  CreateUserRequest: info<CreateUserRequest>(
    "CreateUserRequest",
    "#/definitions/CreateUserRequest"
  ),
  CreateUserResponse: info<CreateUserResponse>(
    "CreateUserResponse",
    "#/definitions/CreateUserResponse"
  ),
  ...
  updatePet_request: info<updatePet_request>(
    "updatePet_request",
    "#/definitions/updatePet_request"
  ),
  updatePetWithForm_request: info<updatePetWithForm_request>(
    "updatePetWithForm_request",
    "#/definitions/updatePetWithForm_request"
  ),
  uploadFile_request: info<uploadFile_request>(
    "uploadFile_request",
    "#/definitions/uploadFile_request"
  ),
