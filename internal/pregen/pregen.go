...
func (o *PreGen) Generate() error {
	...
	// # this is dependent on internal/models/openapi_types.gen.go
	// # - if key is null, AuthRestriction field not set
	// # - no need to use Authorization service RoleByName and ScopeByName,
	// #   directly generate models.Scope("something") and models.Role("..")
...
func (o *PreGen) generateOpIDAuthMiddlewares() error {
	...
	internalformat.PrintJSON(string(opIDAuthInfoBlob))
	if err != nil {
