...
var PublicStructs = map[string]any{
	...
	"DbDbActivity":                                      new(db.DbActivity),
	"DbDbActivityCreateParams":                          new(db.DbActivityCreateParams),
	"DbDbField":                                         new(db.DbField),
	"DbDbUserNotification":                              new(db.DbUserNotification),
	"DbDbUserWIAUWorkItem":                              new(db.DbUserWIAUWorkItem),
	"DbDbUserWIAWorkItem":                               new(db.DbUserWIAWorkItem),
	...
	"DbProjectBoard":                                    new(db.ProjectBoard),
	...
	"DbWorkItemResponse":                                new(db.WorkItemResponse),
