...
var PublicStructs = map[string]any{
	...
	"DbUser__WIA_CacheDemoTwoWorkItem":                 new(db.User__WIA_CacheDemoTwoWorkItem),
	"DbUser__WIA_CacheDemoWorkItem":                    new(db.User__WIA_CacheDemoWorkItem),
	"DbUser__WIA_ExtraSchemaWorkItem":                  new(db.User__WIA_ExtraSchemaWorkItem),
	"DbUser__WIA_ExtraSchemaWorkItemAssignee":          new(db.User__WIA_ExtraSchemaWorkItemAssignee),
	"DbUser__WIA_WorkItem":                             new(db.User__WIA_WorkItem),
	"DbUser__WIA_WorkItemAssignee":                     new(db.User__WIA_WorkItemAssignee),
	...
	"DbWorkItem__WIA_ExtraSchemaUser":                  new(db.WorkItem__WIA_ExtraSchemaUser),
	"DbWorkItem__WIA_ExtraSchemaWorkItemAssignee":      new(db.WorkItem__WIA_ExtraSchemaWorkItemAssignee),
	"DbWorkItem__WIA_User":                             new(db.WorkItem__WIA_User),
	"DbWorkItem__WIA_WorkItemAssignee":                 new(db.WorkItem__WIA_WorkItemAssignee),
	...
	"DemoTwoWorkItems":               new(rest.DemoTwoWorkItems),
	"DemoWorkItems":                  new(rest.DemoWorkItems),
