...
var PublicStructs = map[string]any{
	...
	"RestWorkItemTagUpdateRequest":       new(rest.WorkItemTagUpdateRequest),
	"RestWorkItemType":                   new(rest.WorkItemType),
	"RestWorkItemTypeCreateRequest":      new(rest.WorkItemTypeCreateRequest),
	"RestWorkItemTypeUpdateRequest":      new(rest.WorkItemTypeUpdateRequest),
