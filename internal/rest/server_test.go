...
func TestValidationErrorsResponse(t *testing.T) {
	...
	t.Run("response_validation", func(t *testing.T) {
		...
		jsonErr := "{\"title\":\"invalid response\",\"detail\":\"OpenAPI response validation failed\",\"status\":500,\"error\":\"OpenAPI response validation failed: response body doesn't match schema: $$$${\\\"detail\\\":{\\\"schema\\\":{\\\"type\\\":\\\"integer\\\"},\\\"value\\\":\\\"\\\\\\\"a_wrong_id\\\\\\\"\\\"},\\\"loc\\\":[\\\"id\\\"],\\\"msg\\\":\\\"value must be an integer\\\",\\\"type\\\":\\\"unknown\\\"}\",\"type\":\"ResponseValidation\",\"validationError\":{\"detail\":[{\"detail\":{\"schema\":{\"type\":\"integer\"},\"value\":\"\\\"a_wrong_id\\\"\"},\"loc\":[\"id\"],\"msg\":\"value must be an integer\",\"type\":\"response_validation\"}],\"messages\":[\"response body error\"]}}"
