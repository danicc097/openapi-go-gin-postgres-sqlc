...
func TestValidationErrorsResponse(t *testing.T) {
	...
	t.Run("response_validation", func(t *testing.T) {
		...
		jsonErr := "{\"error\":\"invalid response\",\"message\":\"OpenAPI response validation failed\",\"validationError\":{\"detail\":[{\"detail\":{\"schema\":{\"type\":\"integer\"},\"value\":\"\\\"a_wrong_id\\\"\"},\"loc\":[\"id\"],\"msg\":\"value must be an integer\",\"type\":\"response_validation\"}],\"messages\":[\"response body error\"]}}"
