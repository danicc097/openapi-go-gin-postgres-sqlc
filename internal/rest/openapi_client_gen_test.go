...
type ClientInterface interface {
	...
	CreateEntityNotificationWithBody(ctx context.Context, projectName ProjectName, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	CreateEntityNotification(ctx context.Context, projectName ProjectName, body CreateEntityNotificationJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)
...
func (c *Client) CreateEntityNotificationWithBody(ctx context.Context, projectName ProjectName, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewCreateEntityNotificationRequestWithBody(c.Server, projectName, contentType, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) CreateEntityNotification(ctx context.Context, projectName ProjectName, body CreateEntityNotificationJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewCreateEntityNotificationRequest(c.Server, projectName, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func NewCreateEntityNotificationRequest(server string, projectName ProjectName, body CreateEntityNotificationJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
	...
	bodyReader = bytes.NewReader(buf)
	return NewCreateEntityNotificationRequestWithBody(server, projectName, "application/json", bodyReader)
}

// NewCreateEntityNotificationRequestWithBody generates requests for CreateEntityNotification with any type of body
func NewCreateEntityNotificationRequestWithBody(server string, projectName ProjectName, contentType string, body io.Reader) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/project/%s/entity-notification/", pathParam0)
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
type ClientWithResponsesInterface interface {
	...
	// CreateEntityNotification request with any body
	CreateEntityNotificationWithBodyWithResponse(ctx context.Context, projectName ProjectName, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*CreateEntityNotificationResponse, error)

	CreateEntityNotificationWithResponse(ctx context.Context, projectName ProjectName, body CreateEntityNotificationJSONRequestBody, reqEditors ...RequestEditorFn) (*CreateEntityNotificationResponse, error)
...
func (c *ClientWithResponses) CreateEntityNotificationWithBodyWithResponse(ctx context.Context, projectName ProjectName, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*CreateEntityNotificationResponse, error) {
	rsp, err := c.CreateEntityNotificationWithBody(ctx, projectName, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
...
func (c *ClientWithResponses) CreateEntityNotificationWithResponse(ctx context.Context, projectName ProjectName, body CreateEntityNotificationJSONRequestBody, reqEditors ...RequestEditorFn) (*CreateEntityNotificationResponse, error) {
	rsp, err := c.CreateEntityNotification(ctx, projectName, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseCreateEntityNotificationResponse(rsp)
