...
func NewServer(conf Config, opts ...ServerOption) (*server, error) {
	...
	// TODO how to add certificate? else error creating provider Get "https://authserver.localhost/oidc/.well-known/openid-configuration": x509: certificate is valid for 043d88a742a9ff5b40075d52a0446fd7.555e6493aa59673171806bb237e3b433.traefik.default, not authserver.localhost
