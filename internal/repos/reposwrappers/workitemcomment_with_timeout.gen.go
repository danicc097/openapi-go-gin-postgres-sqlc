...
func (_d WorkItemCommentWithTimeout) ByID(ctx context.Context, d db.DBTX, id int64) (wp1 *db.WorkItemComment, err error) {
	var cancelFunc func()
...
func (_d WorkItemCommentWithTimeout) Create(ctx context.Context, d db.DBTX, params *db.WorkItemCommentCreateParams) (wp1 *db.WorkItemComment, err error) {
	var cancelFunc func()
...
func (_d WorkItemCommentWithTimeout) Delete(ctx context.Context, d db.DBTX, id int64) (wp1 *db.WorkItemComment, err error) {
	var cancelFunc func()
...
func (_d WorkItemCommentWithTimeout) Update(ctx context.Context, d db.DBTX, id int64, params *db.WorkItemCommentUpdateParams) (wp1 *db.WorkItemComment, err error) {
	var cancelFunc func()
