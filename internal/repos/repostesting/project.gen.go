...
type FakeProject struct {
	...
	ByNameStub        func(context.Context, models.DBTX, models.Project, ...models.ProjectSelectConfigOption) (*models.Project, error)
...
func (fake *FakeProject) ByName(arg1 context.Context, arg2 models.DBTX, arg3 models.Project, arg4 ...models.ProjectSelectConfigOption) (*models.Project, error) {
...
func (fake *FakeProject) ByNameCalls(stub func(context.Context, models.DBTX, models.Project, ...models.ProjectSelectConfigOption) (*models.Project, error)) {
	fake.byNameMutex.Lock()
	defer fake.byNameMutex.Unlock()
	fake.ByNameStub = stub
}

func (fake *FakeProject) ByNameArgsForCall(i int) (context.Context, models.DBTX, models.Project, []models.ProjectSelectConfigOption) {
	fake.byNameMutex.RLock()
	defer fake.byNameMutex.RUnlock()
