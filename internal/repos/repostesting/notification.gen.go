...
type FakeNotification struct {
	CreateStub        func(context.Context, db.DBTX, db.CreateNotificationParams) error
	createMutex       sync.RWMutex
	createArgsForCall []struct {
		arg1 context.Context
		arg2 db.DBTX
		arg3 db.CreateNotificationParams
	}
	...
	DeleteStub        func(context.Context, db.DBTX, int32) error
...
func (fake *FakeNotification) Create(arg1 context.Context, arg2 db.DBTX, arg3 db.CreateNotificationParams) error {
...
func (fake *FakeNotification) CreateCalls(stub func(context.Context, db.DBTX, db.CreateNotificationParams) error) {
	fake.createMutex.Lock()
	defer fake.createMutex.Unlock()
	fake.CreateStub = stub
}

func (fake *FakeNotification) CreateArgsForCall(i int) (context.Context, db.DBTX, db.CreateNotificationParams) {
	fake.createMutex.RLock()
	defer fake.createMutex.RUnlock()
...
func (fake *FakeNotification) CreateReturns(result1 error) {
	fake.createMutex.Lock()
	defer fake.createMutex.Unlock()
	fake.CreateStub = nil
...
func (fake *FakeNotification) CreateReturnsOnCall(i int, result1 error) {
	fake.createMutex.Lock()
	defer fake.createMutex.Unlock()
	fake.CreateStub = nil
...
func (fake *FakeNotification) Delete(arg1 context.Context, arg2 db.DBTX, arg3 int32) error {
...
func (fake *FakeNotification) DeleteCalls(stub func(context.Context, db.DBTX, int32) error) {
	fake.deleteMutex.Lock()
	defer fake.deleteMutex.Unlock()
	fake.DeleteStub = stub
}

func (fake *FakeNotification) DeleteArgsForCall(i int) (context.Context, db.DBTX, int32) {
	fake.deleteMutex.RLock()
	defer fake.deleteMutex.RUnlock()
...
func (fake *FakeNotification) DeleteReturns(result1 error) {
	fake.deleteMutex.Lock()
	defer fake.deleteMutex.Unlock()
	fake.DeleteStub = nil
...
func (fake *FakeNotification) DeleteReturnsOnCall(i int, result1 error) {
	fake.deleteMutex.Lock()
	defer fake.deleteMutex.Unlock()
	fake.DeleteStub = nil
