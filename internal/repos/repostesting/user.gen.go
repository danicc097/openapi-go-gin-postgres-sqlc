...
type FakeUser struct {
	...
	PaginatedStub        func(context.Context, db.DBTX, repos.GetPaginatedUsersParams) ([]db.User, error)
...
func (fake *FakeUser) Paginated(arg1 context.Context, arg2 db.DBTX, arg3 repos.GetPaginatedUsersParams) ([]db.User, error) {
...
func (fake *FakeUser) PaginatedCalls(stub func(context.Context, db.DBTX, repos.GetPaginatedUsersParams) ([]db.User, error)) {
	fake.paginatedMutex.Lock()
	defer fake.paginatedMutex.Unlock()
	fake.PaginatedStub = stub
}

func (fake *FakeUser) PaginatedArgsForCall(i int) (context.Context, db.DBTX, repos.GetPaginatedUsersParams) {
	fake.paginatedMutex.RLock()
	defer fake.paginatedMutex.RUnlock()
