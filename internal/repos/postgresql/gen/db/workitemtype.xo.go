...
left join work_items on work_items.work_item_type_id = work_item_types.work_item_type_id` +
		` WHERE work_item_types.work_item_type_id > $3 GROUP BY projects.project_id, work_item_types.project_id, 
work_items.work_item_type_id, work_item_types.work_item_type_id `
	sqlstr += c.limit
...
-- O2O join generated from "work_items_work_item_type_id_fkey(O2O inferred)"
left join work_items on work_items.work_item_type_id = work_item_types.work_item_type_id` +
		` WHERE work_item_types.project_id > $3 GROUP BY projects.project_id, work_item_types.project_id, 
work_items.work_item_type_id, work_item_types.work_item_type_id `
	sqlstr += c.limit
...
-- O2O join generated from "work_items_work_item_type_id_fkey(O2O inferred)"
left join work_items on work_items.work_item_type_id = work_item_types.work_item_type_id` +
		` WHERE work_item_types.name = $3 AND work_item_types.project_id = $4 GROUP BY projects.project_id, work_item_types.project_id, 
work_items.work_item_type_id, work_item_types.work_item_type_id `
	sqlstr += c.orderBy
	sqlstr += c.limit
...
-- O2O join generated from "work_items_work_item_type_id_fkey(O2O inferred)"
left join work_items on work_items.work_item_type_id = work_item_types.work_item_type_id` +
		` WHERE work_item_types.name = $3 GROUP BY projects.project_id, work_item_types.project_id, 
work_items.work_item_type_id, work_item_types.work_item_type_id `
	sqlstr += c.orderBy
	sqlstr += c.limit
