...
func WithWorkItemWorkItemTagOrderBy(rows map[string]*models.Direction) WorkItemWorkItemTagSelectConfigOption {
	return func(s *WorkItemWorkItemTagSelectConfig) {
...
func WorkItemWorkItemTagPaginated(ctx context.Context, db DB, cursor models.PaginationCursor, opts ...WorkItemWorkItemTagSelectConfigOption) ([]WorkItemWorkItemTag, error) {
