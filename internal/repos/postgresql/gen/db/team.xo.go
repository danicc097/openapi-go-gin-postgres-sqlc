...
left join (
	...
	if err := db.QueryRow(ctx, sqlstr, c.joins.TimeEntries, c.joins.Users, name).Scan(&t.TeamID, &t.ProjectID, &t.Name, &t.Description, &t.CreatedAt, &t.UpdatedAt, &t.TimeEntries, &t.Users); err != nil {
