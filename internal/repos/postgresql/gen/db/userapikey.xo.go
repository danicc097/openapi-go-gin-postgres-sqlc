...
// WithUserAPIKeyFilters adds the given filters, which may be parameterized with $i.
...
func (uak *UserAPIKey) Upsert(ctx context.Context, db DB, params *UserAPIKeyCreateParams) (*UserAPIKey, error) {
	...
	if err != nil {
		...
		if errors.As(err, &pgErr) {
			...
			uak, err = uak.Update(ctx, db, &UserAPIKeyUpdateParams{APIKey: pointers.New(params.APIKey),
