...
(case when $3::boolean = true then array_agg(joined_time_entries.time_entries) end) as time_entries,
(case when $4::boolean = true then array_agg(joined_work_item_comments.work_item_comments) end) as work_item_comments,
(case when $5::boolean = true then array_agg(joined_users.users) end) as users,
(case when $6::boolean = true then array_agg(joined_work_item_tags.work_item_tags) end) as work_item_tags,
