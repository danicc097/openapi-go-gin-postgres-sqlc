...
(case when $3::boolean = true and user_api_keys.user_id is not null then row(user_api_keys.*) end) as user_api_key,
(case when $4::boolean = true then COALESCE(joined_user_notifications.user_notifications, '{}') end) as user_notifications,
(case when $5::boolean = true then COALESCE(joined_teams.__teams, '{}') end) as teams,
(case when $6::boolean = true then COALESCE(joined_work_item_comments.work_item_comments, '{}') end) as work_item_comments,
...
-- O2O join generated from "user_api_keys_user_id_fkey(1)"
...
`+
	...
	rows, err := db.Query(ctx, sqlstr, c.joins.NotificationsReceiver, c.joins.TimeEntries, c.joins.UserAPIKey, c.joins.UserNotifications, c.joins.Teams, c.joins.WorkItemComments, c.joins.WorkItems, createdAt)
	if err != nil {
		return nil, logerror(err)
	}
	defer rows.Close()
...
`+
	...
	rows, err := db.Query(ctx, sqlstr, c.joins.NotificationsReceiver, c.joins.TimeEntries, c.joins.UserAPIKey, c.joins.UserNotifications, c.joins.Teams, c.joins.WorkItemComments, c.joins.WorkItems, deletedAt)
	if err != nil {
		return nil, logerror(err)
	}
	defer rows.Close()
...
`+
	...
	// run
	// logf(sqlstr, email)
	rows, err := db.Query(ctx, sqlstr, c.joins.NotificationsReceiver, c.joins.TimeEntries, c.joins.UserAPIKey, c.joins.UserNotifications, c.joins.Teams, c.joins.WorkItemComments, c.joins.WorkItems, email)
	if err != nil {
...
`+
	...
	rows, err := db.Query(ctx, sqlstr, c.joins.NotificationsReceiver, c.joins.TimeEntries, c.joins.UserAPIKey, c.joins.UserNotifications, c.joins.Teams, c.joins.WorkItemComments, c.joins.WorkItems, externalID)
	if err != nil {
...
`+
	...
	// run
	// logf(sqlstr, userID)
	rows, err := db.Query(ctx, sqlstr, c.joins.NotificationsReceiver, c.joins.TimeEntries, c.joins.UserAPIKey, c.joins.UserNotifications, c.joins.Teams, c.joins.WorkItemComments, c.joins.WorkItems, userID)
	if err != nil {
...
`+
	...
	rows, err := db.Query(ctx, sqlstr, c.joins.NotificationsReceiver, c.joins.TimeEntries, c.joins.UserAPIKey, c.joins.UserNotifications, c.joins.Teams, c.joins.WorkItemComments, c.joins.WorkItems, updatedAt)
	if err != nil {
		return nil, logerror(err)
	}
	defer rows.Close()
...
`+
	...
	rows, err := db.Query(ctx, sqlstr, c.joins.NotificationsReceiver, c.joins.TimeEntries, c.joins.UserAPIKey, c.joins.UserNotifications, c.joins.Teams, c.joins.WorkItemComments, c.joins.WorkItems, username)
	if err != nil {
