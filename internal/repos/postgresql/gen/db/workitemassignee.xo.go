...
func WorkItemAssigneePaginated(ctx context.Context, db DB, cursor models.PaginationCursor, opts ...WorkItemAssigneeSelectConfigOption) ([]WorkItemAssignee, error) {
