...
type DemoTwoWorkItem struct {
	WorkItemID            DemoTwoWorkItemID `json:"workItemID" db:"work_item_id" required:"true" nullable:"false"` // work_item_id
...
type DemoTwoWorkItemCreateParams struct {
	...
	WorkItemID            DemoTwoWorkItemID `json:"-" required:"true" nullable:"false"` // work_item_id
}
