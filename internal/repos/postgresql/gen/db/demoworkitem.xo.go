...
type DemoWorkItem struct {
	WorkItemID    DemoWorkItemID `json:"workItemID" db:"work_item_id" required:"true" nullable:"false"`       // work_item_id
...
type DemoWorkItemCreateParams struct {
	...
	WorkItemID    DemoWorkItemID `json:"-" required:"true" nullable:"false"`                        // work_item_id
}
