...
func DemoWorkItemPaginatedByWorkItemID(ctx context.Context, db DB, workItemID WorkItemID, direction Direction, opts ...DemoWorkItemSelectConfigOption) ([]DemoWorkItem, error) {
