...
func ExtraSchemaDemoWorkItemPaginated(ctx context.Context, db DB, cursors []Cursor, opts ...ExtraSchemaDemoWorkItemSelectConfigOption) ([]ExtraSchemaDemoWorkItem, error) {
