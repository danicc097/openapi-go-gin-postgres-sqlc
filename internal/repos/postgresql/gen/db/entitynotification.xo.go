...
func EntityNotificationPaginated(ctx context.Context, db DB, cursor models.PaginationCursor, opts ...EntityNotificationSelectConfigOption) ([]EntityNotification, error) {
