...
// Book represents a row from 'extra_schema.books'.
...
// BookCreateParams represents insert params for 'extra_schema.books'.
...
// BookUpdateParams represents update params for 'extra_schema.books'.
...
// User__BA_Book represents a M2M join against "extra_schema.book_authors"
type User__BA_Book struct {
	User      User    `json:"user" db:"users" required:"true"`
	Pseudonym *string `json:"pseudonym" db:"pseudonym" required:"true" `
}

// User__BASK_Book represents a M2M join against "extra_schema.book_authors_surrogate_key"
...
// BookByBookID retrieves a row from 'extra_schema.books' as a Book.
//
