...
// Notification represents a row from 'extra_schema.notifications'.
...
// NotificationCreateParams represents insert params for 'extra_schema.notifications'.
...
// NotificationUpdateParams represents update params for 'extra_schema.notifications'.
...
func (n *Notification) Insert(ctx context.Context, db DB) (*Notification, error) {
	...
	// run
	logf(sqlstr, n.Body, n.NotificationType, n.Receiver, n.Sender)

	rows, err := db.Query(ctx, sqlstr, n.Body, n.NotificationType, n.Receiver, n.Sender)
	if err != nil {
...
func (n *Notification) Update(ctx context.Context, db DB) (*Notification, error) {
	...
	RETURNING * `
	// run
	logf(sqlstr, n.Body, n.NotificationType, n.Receiver, n.Sender, n.NotificationID)

	rows, err := db.Query(ctx, sqlstr, n.Body, n.NotificationType, n.Receiver, n.Sender, n.NotificationID)
	if err != nil {
...
// NotificationByNotificationID retrieves a row from 'extra_schema.notifications' as a Notification.
//
...
// NotificationsBySender retrieves a row from 'extra_schema.notifications' as a Notification.
//
