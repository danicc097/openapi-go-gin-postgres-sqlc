...
// NotificationType is the 'notification_type' enum type from schema 'extra_schema'.
...
// NullNotificationType represents a null 'notification_type' enum for schema 'extra_schema'.
