...
func WorkItemTagPaginatedByWorkItemTagID(ctx context.Context, db DB, , opts ...WorkItemTagSelectConfigOption) ([]WorkItemTag, error) {
...
left join (
  ...
  group by
	...
	rows, err := db.Query(ctx, sqlstr, wit.WorkItemTagID)
	if err != nil {
...
func WorkItemTagPaginatedByProjectID(ctx context.Context, db DB, , opts ...WorkItemTagSelectConfigOption) ([]WorkItemTag, error) {
	c := &WorkItemTagSelectConfig{joins: WorkItemTagJoins{},
}
