...
left join (
  ...
  group by
		...
		` WHERE projects.project_id > $6 GROUP BY joined_activities.activities, projects.project_id, 
...
left join (
  ...
  group by
        project_id) joined_work_item_types on joined_work_item_types.work_item_types_project_id = projects.project_id` +
		` WHERE projects.name = $6 GROUP BY joined_activities.activities, projects.project_id, 
joined_kanban_steps.kanban_steps, projects.project_id, 
joined_teams.teams, projects.project_id, 
joined_work_item_tags.work_item_tags, projects.project_id, 
joined_work_item_types.work_item_types, projects.project_id `
...
left join (
  ...
  group by
        project_id) joined_work_item_types on joined_work_item_types.work_item_types_project_id = projects.project_id` +
		` WHERE projects.work_items_table_name = $6 GROUP BY joined_activities.activities, projects.project_id, 
joined_kanban_steps.kanban_steps, projects.project_id, 
joined_teams.teams, projects.project_id, 
joined_work_item_tags.work_item_tags, projects.project_id, 
joined_work_item_types.work_item_types, projects.project_id `
