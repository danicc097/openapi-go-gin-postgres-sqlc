...
(case when $1::boolean = true and book_ids.book_id is not null then row(book_ids.*) end) as book_book_id,
(case when $2::boolean = true and reviewers.user_id is not null then row(reviewers.*) end) as user_reviewer ` +
		`FROM xo_tests.book_reviews ` +
		`-- O2O join generated from "book_reviews_book_id_fkey (Generated from M2O)"
left join xo_tests.books as book_ids on book_ids.book_id = book_reviews.book_id
-- O2O join generated from "book_reviews_reviewer_fkey (Generated from M2O)"
left join xo_tests.users as reviewers on reviewers.user_id = book_reviews.reviewer` +
		` WHERE book_reviews.book_review_id > $3 GROUP BY book_ids.book_id, book_ids.book_id, book_reviews.book_review_id, 
reviewers.user_id, reviewers.user_id, book_reviews.book_review_id `
	sqlstr += c.limit
...
-- O2O join generated from "book_reviews_reviewer_fkey (Generated from M2O)"
left join xo_tests.users as reviewers on reviewers.user_id = book_reviews.reviewer` +
		` WHERE book_reviews.book_id > $3 GROUP BY book_ids.book_id, book_ids.book_id, book_reviews.book_review_id, 
reviewers.user_id, reviewers.user_id, book_reviews.book_review_id `
	sqlstr += c.limit
...
-- O2O join generated from "book_reviews_reviewer_fkey (Generated from M2O)"
left join xo_tests.users as reviewers on reviewers.user_id = book_reviews.reviewer` +
		` WHERE book_reviews.reviewer = $3 AND book_reviews.book_id = $4 GROUP BY book_ids.book_id, book_ids.book_id, book_reviews.book_review_id, 
reviewers.user_id, reviewers.user_id, book_reviews.book_review_id `
	sqlstr += c.orderBy
	sqlstr += c.limit
...
-- O2O join generated from "book_reviews_reviewer_fkey (Generated from M2O)"
left join xo_tests.users as reviewers on reviewers.user_id = book_reviews.reviewer` +
		` WHERE book_reviews.reviewer = $3 GROUP BY book_ids.book_id, book_ids.book_id, book_reviews.book_review_id, 
reviewers.user_id, reviewers.user_id, book_reviews.book_review_id `
	sqlstr += c.orderBy
	sqlstr += c.limit
